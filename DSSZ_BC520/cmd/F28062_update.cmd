...
PAGE 0:    /* Program Memory */
  ...
  // For RAML1L2L3 双口RAM
   RAML1L2L3   : origin = 0x008000, length = 0x004000     /* on-chip RAM block L1,L2,L3 */
 ...
 //  FLASHG      : origin = 0x3F1000, length = 0x001000     /* on-chip FLASH */
  ...
  // FLASHC    : origin = 0x3F5000, length = 0x001000     /* on-chip FLASH */
   ...
   // For 用户程序
   FLASHBCDEFGH   : origin = 0x3E8000, length = 0x00DF80     /* on-chip FLASH 0x00DF80 */
  ...
  // FLASHB      : origin = 0x3F6000, length = 0x001000     /* on-chip FLASH */
   ...
   BEGIN       : origin = 0x3F5FF6, length = 0x000002     /* Part of FLASHA.  Used for "boot to Flash" bootloader mode. */
...
SECTIONS
{
   ...
   .cinit              : > FLASHBCDEFGH     PAGE = 0
   .pinit              : > FLASHBCDEFGH     PAGE = 0
   .text               : > FLASHBCDEFGH     PAGE = 0
   codestart           : > BEGIN         PAGE = 0

   ramfuncs            : LOAD = FLASHBCDEFGH,
                         RUN  = RAML1L2L3,
   ...
   .econst             : > FLASHBCDEFGH      PAGE = 0
   .switch             : > FLASHBCDEFGH      PAGE = 0

   /* Allocate IQ math areas: */
 //  IQmath              : > FLASHA      PAGE = 0            /* Math Code */

   IQmath              : LOAD = FLASHBCDEFGH,
                         RUN  = RAML1L2L3,
